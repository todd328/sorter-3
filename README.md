...
Standalone Windows build of the OPEX Sorter 3 barcode routing service.
...
3. Under **Artifacts**, download `SorterThree-windows`.
4. Unzip it — you'll get `SorterThree.exe`, ready to run on Windows (no Python install required).
