...
# ---------------------------------------------------------------------------
VERSION = "2.0"
HOST_IP = os.environ.get("SURESORT_HOST", "172.17.0.61")
...
BARCODE_ROUTES = {
    23: ("sortc2053", "Replenishment"),
    16: ("sortc2053", "Replenishment"),
    11: ("sortc3053", "Lab Jobs"),
    25: ("sortc4053", "X-Dock Orders"),
    10: ("sortc3063", "Enclosures"),
}
